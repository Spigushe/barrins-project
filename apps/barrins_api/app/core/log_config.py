...
Renamed from logging.py to avoid shadowing the stdlib logging module.
"""
...
class _WindowsSafeRotatingFileHandler(RotatingFileHandler):
    ...
    def rotate(self, source: str, dest: str) -> None:
        ...
        # Empty the source file in place — no rename, no WinError 32.
...
def setup_logging(logger_name: str | None = None) -> logging.Logger:
    ...
    Args:
        logger_name: Name of the logger to create. If None, returns the root logger.
