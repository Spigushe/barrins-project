...
class JSONBCompat(TypeDecorator[JsonValue]):
    ...
    def process_bind_param(
        ...
        # Runtime validation: guarantees the whole structure is JSON-serializable.
        try:
            json.dumps(value)
...
def jsonb_column(
    *,
    ...
    Args:
        default: Scalar default value (``None`` = no default).
        nullable: If ``True``, the column accepts ``NULL``.
    """
