  ...
  'inline-flex items-center rounded-(--radius-input) border px-2 py-0.5 text-[11.5px] font-semibold uppercase tracking-[0.04em] w-fit',
  {
    variants: {
      variant: {
        ...
        owner: 'border-owner/35 bg-owner/12 text-owner',
        shared: 'border-shared/35 bg-shared/12 text-shared',
        tournament: 'border-tournament/35 bg-tournament/12 text-tournament',
      },
    },
