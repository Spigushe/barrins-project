...
## What's here (login slice — Goblin Guide bootstrap `G-03` step 1)
...
Later slices add signup + email verification, password reset, account
settings + delete, and admin service-account management, in that order.
