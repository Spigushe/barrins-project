...
alongside a reciprocal "blocks S2" note on S5's row. **Every item
...
| S2 | Team sharing: read-only "Team Decks" selector + flag-to-share | I5, S1, S5 | Builds on S1's mechanism once teams exist. **Deck-validation gate deferred to v3.0.0 (2026-07-27)** — S2 no longer depends on S8. **S5 dependency flagged 2026-07-30** — team members' PDF-report access (Done statement, UAT) needs S5 built first, previously missing from this row | [s2-team-sharing/](s2-team-sharing/index.md) |
...
| S5 | PDF report of a training session for a specific deck | S3, S9 (S9 defines what a "training session" actually is — resolves this item's open scoping question) | Backend-generated (Constitution §4.1: no client-side composition of computed stats). **I8 resolved 2026-07-27: WeasyPrint** (see S5 page for the full Context/Alternatives/Trade-offs research). **Blocks S2 (flagged 2026-07-30)** — team members' PDF-report access is part of S2's Done statement | [s5-pdf-training-report/](s5-pdf-training-report/index.md) |
