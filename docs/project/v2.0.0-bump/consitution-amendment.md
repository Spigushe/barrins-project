...
| **Status** | ✅ Proposals 1–6 reviewed and accepted (1, 4, 5, 6 as written; 2, 3 with modifications, see each). ✅ **Proposal 7 amended and accepted 2026-09-04** (reverses its original 2026-08-03 decision — see its own "What changed"). ✅ **Proposal 8 added and accepted 2026-08-24, applied directly to `.claude/CLAUDE.md` the same day** (§11.8). **✅ Proposals 1–8 are now all applied to `.claude/CLAUDE.md`** (2026-09-04 — §13.6, §13.7, §18.5, §23.4, §26.5, §31.4 added; see "Applying these proposals" below for what changed from the original text). | / |
...
4. **Still outstanding, not done in this pass**: per R5 (`index.md` Group
   ...
   next should treat Proposals 1–8 as all still needing their ADR.
