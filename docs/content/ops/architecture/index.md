...
- [Decision Records](decisions.md) — secrets management (ADR-1),
  ...
  v1.0.0 release's backup/monitoring/Moxfield decisions (ADR-4), and
  adopting Barrin's Identity as the RS256/JWKS authority (ADR-16, which
  lifts ADR-7's delay), in Constitution §16.3 format.
